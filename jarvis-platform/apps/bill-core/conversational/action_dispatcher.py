...
class ActionDispatcher:
    ...
    def dispatch(self, routed_intent: RoutedIntent, tenant_id: str, user_id: str) -> dict[str, str | None]:
        ...
        try:
            ...
            if workflow_id == "smart_sherpa_sync":
                task_payload["run_mode"] = "batch"
                task_payload["workflow_id"] = workflow_id
                task_payload["source_record"] = {"run_mode": "batch"}
                task_payload["target_contact"] = {"run_mode": "batch"}
                task_payload["attach_to_existing"] = True
                task_payload["require_existing_page"] = True
                task_payload["allow_launch_fallback"] = False
                task_payload["browser_profile_policy"] = "attach_existing_debug"
