...
$coreCommand = "Set-Location -Path `"$corePath`"; `$env:BILL_CORE_HOST=`"0.0.0.0`"; `$env:BILL_CORE_PORT=`"8000`"; & `"$corePythonExe`" -m uvicorn main:app --reload --host 0.0.0.0 --port 8000"
