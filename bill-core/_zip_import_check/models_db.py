...
class WorkerRelease(Base):
    ...
    # Download Center fields: status supersedes is_active for UI display.
    # Values: current | draft | deprecated | disabled
    status: Mapped[str] = mapped_column(Text, nullable=True, default="draft", index=True)
    ...
    released_by_user_id: Mapped[str] = mapped_column(Text, nullable=True)
    released_by_name: Mapped[str] = mapped_column(Text, nullable=True)
...
class UserSession(Base):
    ...
    created_ip: Mapped[str] = mapped_column(Text, nullable=True)
...
class AuditLogEntry(Base):
    ...
    actor_user_id: Mapped[str] = mapped_column(Text, nullable=True, index=True)
    actor_user_name: Mapped[str] = mapped_column(Text, nullable=True)
    actor_role: Mapped[str] = mapped_column(Text, nullable=True, index=True)
    target_type: Mapped[str] = mapped_column(Text, nullable=True, index=True)
    target_id: Mapped[str] = mapped_column(Text, nullable=True, index=True)
    request_method: Mapped[str] = mapped_column(Text, nullable=True)
    request_path: Mapped[str] = mapped_column(Text, nullable=True)
    status_code: Mapped[int] = mapped_column(Integer, nullable=True)
    details_json: Mapped[str] = mapped_column(Text, nullable=True)
    redacted_payload: Mapped[str] = mapped_column(Text, nullable=True)
...
# ---------------------------------------------------------------------------
# Tenant Integration Credentials (encrypted secrets)
# ---------------------------------------------------------------------------
...
class IntegrationCredential(Base):
    ...
    id: Mapped[str] = mapped_column(Text, primary_key=True)
    tenant_id: Mapped[str] = mapped_column(Text, ForeignKey("tenants.id"), nullable=False, index=True)
    integration_type: Mapped[str] = mapped_column(Text, nullable=False, index=True)
    name: Mapped[str] = mapped_column(Text, nullable=False)
    status: Mapped[str] = mapped_column(Text, nullable=False, default="active", index=True)
    settings_json: Mapped[str] = mapped_column(Text, nullable=True)
    secret_encrypted: Mapped[str] = mapped_column(Text, nullable=False)
    secret_masked: Mapped[str] = mapped_column(Text, nullable=False)
    created_by_user_id: Mapped[str] = mapped_column(Text, nullable=True)
    created_by_name: Mapped[str] = mapped_column(Text, nullable=True)
    updated_by_user_id: Mapped[str] = mapped_column(Text, nullable=True)
    updated_by_name: Mapped[str] = mapped_column(Text, nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
    updated_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow, onupdate=datetime.utcnow)
